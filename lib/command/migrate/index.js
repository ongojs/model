 ...
 * @requires Cli
 *
 * @classdesc MigrateCommand class
 */

//  const Migrate = require("@mongodb-model/db-migrate");
class MigrateCommand extends require("@mongodb-model/cli") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(MigrateCommand);
    // auto invoke methods
    this.autoinvoker(MigrateCommand);
...
\x1b[36m DESCRIPTION\x1b[0m
 ...
 \x1b[36m  The following options are available: \x1b[0m `;
  ...
  migrate() {
    const { migrate, migrateSchema, migrateAll } = new Migrate({
